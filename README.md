# Gilded rose for pacotes
Built in .netCore 2.1
...
Clone the repository. Run the code with the dotnet run cli command. Run the tests with the dotnet tests CLI command.
